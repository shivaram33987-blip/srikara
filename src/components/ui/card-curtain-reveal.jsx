...
const CardCurtainRevealFooter = React.forwardRef(({ className, children, ...props }, ref) => {
...
const CardCurtainRevealBody = React.forwardRef(({ className, ...props }, ref) => {
  return <div ref={ref} className={cn("flex-1 p-6 relative z-10", className)} {...props} />
})
...
const CardCurtainRevealTitle = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <motion.h2
      ref={ref}
      className={className}
      animate={isMouseIn ? { y: 0, opacity: 1 } : { y: 15, opacity: 0.9 }}
...
const CardCurtain = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        "pointer-events-none absolute inset-0 size-full mix-blend-difference z-20",
        className
      )}
      variants={curtainVariants}
      animate={isMouseIn ? "visible" : "hidden"}
