...
/**
 * @typedef {Object} StarBackgroundProps
 * @property {string} [color]
 */

/**
 * @param {StarBackgroundProps} props
 */
...
/**
 * @typedef {Object} StarButtonProps
 * @property {React.ReactNode} children
 * @property {number} [lightWidth=110]
 * @property {number} [duration=3]
 * @property {string} [lightColor="#FAFAFA"]
 * @property {string} [backgroundColor="currentColor"]
 * @property {number} [borderWidth=2]
 * @property {string} [className]
 */

/**
 * @param {StarButtonProps} props
 */
